...
public class EntryDataShowVO {
	...
	public Date getTglTerimaPaketDate(){
		return this.tglTerimaPaketDate;
	}
	...
	private int cgkreg, harga, totalasuransi, asuransi, totalBiaya, diskonRapid, biaya, diskon, diskonJne,
			biayaSblmDiskon, diskonPelanggan, NoLaporan,inboundFlag, flagLunas, id;
	...
	//chris nambah
	private String tglTerimaConcate;
	private String idKardusSub;
	
	public String getWaktuTerimaPaket(){
		return waktuTerimaPaket;
	}
	
	public void setWaktuTerimaPaket(String waktuTerimaPaket) {
		this.waktuTerimaPaket = waktuTerimaPaket;
	}
	...
	public String getTglTerimaPaket() {
		return tglTerimaPaket;
	}

	public void setTglTerimaPaket(String tglTerimaPaket) {
	...
	public String getTglTerimaConcate() {
		return tglTerimaConcate;
	}

	public void setTglTerimaConcate(String tglTerimaConcate) {
		this.tglTerimaConcate = tglTerimaConcate;
	}

	public EntryDataShowVO(String awbData, String kdPickup, String pengirim, String penerima, String tujuan,
			String ketTujuan, String kdPerwakilan, String ket, String volume, String bVolume, String bpVolume,
			String timbang, String btTimbang, String bFinal, String bpFinal, Integer cgkreg, Integer harga,
			Integer asuransi, Integer totalBiaya, String resseler, String idDataPaket, String tglTerimaConcate) {
		this.awbData = awbData;
		this.kdPickup = kdPickup;
		this.pengirim = pengirim;
		this.penerima = penerima;
