...
public class TrPelanggan implements java.io.Serializable {
	...
	public String getAsalPelanggan(){
		return this.asalPelanggan;
	}
	
	public void setAsalPelanggan(String asalPelanggan){
	...
	public TrPelanggan(String kodePelanggan, String namaAkun, String namaPemilik, String email, String telp,
			...
			Date tglUpdate, Integer flag, Date tglAkhirDiskon, String asalPelanggan) {
		this.kodePelanggan = kodePelanggan;
		...
		this.flag = flag;
		this.tglAkhirDiskon = tglAkhirDiskon;
		this.asalPelanggan = asalPelanggan;
	}
	...
	public Date getTglAkhirDiskon() {
		return this.tglAkhirDiskon;
	}

	public void setTglAkhirDiskon(Date tglAkhirDiskon) {
		this.tglAkhirDiskon = tglAkhirDiskon;
	}
